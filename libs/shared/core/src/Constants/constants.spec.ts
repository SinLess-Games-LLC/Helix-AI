...
describe('Constants', () => {
  ...
  describe('StatusUrls', () => {
    it('should have the correct Discord status URLs', () => {
      expect(StatusUrls.discord.summary).toBe('https://discordstatus.com/api/v2/summary.json');
      expect(StatusUrls.discord.status).toBe('https://discordstatus.com/api/v2/status.json');
    });

    it('should have the correct Cloudflare status URLs', () => {
      expect(StatusUrls.cloudflare.summary).toBe('https://www.cloudflarestatus.com/api/v2/summary.json');
      expect(StatusUrls.cloudflare.status).toBe('https://www.cloudflarestatus.com/api/v2/status.json');
    });
  })
})
